...
const values = [
  {
    icon: Sparkles,
    t: "AI-First Thinking",
    d: "Every project begins with the question: how can intelligence make this better?",
  },
...
drive growth."
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <SectionHeading
              ...
              title={
                <>
                  From a small studio to a <span className="text-gradient">global AI partner</span>
                </>
              }
            />
            <div className="space-y-4 text-muted-foreground">
              <p>
                ALStream Tech was founded on a simple belief: software becomes remarkable when it thinks with you. What
                started as a boutique engineering studio quickly grew into a full-service AI + software team as clients
                asked us to do more — from strategy and design to ML models, cloud platforms and long-term support.
              </p>
              <p>
                Today we're a distributed team across three continents, delivering everything from AI agents and SaaS
                platforms to enterprise automation for startups and Fortune 500s alike.
              </p>
              <p>
                We're not a big agency. We're a senior team that pairs deeply with yours to ship software that matters.
              </p>
            </div>
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="glass-strong rounded-3xl p-10">
            ...
            <p className="mt-3 text-muted-foreground">
              To make every business more intelligent, efficient and human by pairing world-class engineering with
              practical AI.
            </p>
          </div>
          <div className="glass-strong rounded-3xl p-10">
            ...
            <p className="mt-3 text-muted-foreground">
              A world where every organization — from startups to enterprises — ships intelligent software that changes
              their industry.
            </p>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <SectionHeading
          ...
          title={
            <>
              Senior specialists, <span className="text-gradient">united by craft</span>
            </>
          }
        />
